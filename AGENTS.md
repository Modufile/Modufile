# Modufile Project Constitution (AGENTS.md)
...
## 12. Docs Protocol (MANDATORY)

At the **start of every session**, read these files before doing any work:
- `docs/current_state.md` — feature matrix, architecture, known gaps
- `docs/task_plan.md` — what's done and what's next
- `docs/findings.md` — technical decisions, gotchas, coordinate systems
- `docs/design.md` — brand, color system, typography, UI patterns, component styles

After **any code change**, update the relevant docs:
- `docs/current_state.md` — update feature status, architecture, known gaps
- `docs/progress.md` — add a dated entry describing what changed and any errors hit
- `docs/task_plan.md` — check off completed items, add new tasks discovered
- `docs/findings.md` — record new technical discoveries, gotchas, or decisions
- `docs/design.md` — update if any UI patterns, component styles, or design decisions changed

**Rule:** Never end a session having changed code without updating the docs. The docs are the source of truth for what the project is and what comes next.