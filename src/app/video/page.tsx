        ...
        <div className="min-h-screen bg-[#0A0A0A] p-6 pt-12 md:pt-20">
            <div className="max-w-6xl mx-auto space-y-12">
                <div className="space-y-4 text-center">
                    <h1 className="text-3xl md:text-4xl font-bold text-zinc-100">Video Tools</h1>
                    <p className="text-zinc-400 max-w-2xl mx-auto">
                        Convert, trim, and extract audio — hardware-accelerated in your browser via WebCodecs. No uploads.
                    </p>
                </div>
